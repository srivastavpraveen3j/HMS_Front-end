...
import { WalkinpathotestComponent } from '../../component/testcomponent/walkinpathotest/walkinpathotest.component';
import { TestService } from '../../viewspatho/testservice/test.service';
import { environment } from '../../../../enviornment/env';

@Component({
  selector: 'app-radiodashboardwalkin',
  imports: [
    CommonModule,
    ...
    RouterModule,
    WalkinpathotestComponent,
  ],
  templateUrl: './radiodashboardwalkin.component.html',
  styleUrl: './radiodashboardwalkin.component.css',
})
export class RadiodashboardwalkinComponent {
  doctors: any[] = [];
