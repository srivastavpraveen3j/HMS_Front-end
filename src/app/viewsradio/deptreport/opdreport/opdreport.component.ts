    ...
    applyDateRange() {
      ...
      switch (this.selectedRange) {
        case 'today':
          ...
          this.subTitle = ` - Today's OPD Radiology Report (${formatDate(
            startDate
          )})`;
          break;
        case 'week':
          ...
          this.subTitle = ` - This Week OPD Radiology Report (${formatDate(
            startDate
          )} to ${formatDate(new Date())})`;
          break;
        case 'month':
          startDate = new Date(today.getFullYear(), today.getMonth(), 1);
          this.subTitle = ` - This Month OPD Radiology Report (${formatDate(
            startDate
          )} to ${formatDate(today)})`;
          break;
        case 'year':
          ...
          endDate = today;
          this.subTitle = ` - This Year OPD Radiology Report (${formatDate(
            startDate
