...
@Component({
  selector: 'app-radiotestmasterparameterlist',
    imports: [RouterModule, CommonModule, ReactiveFormsModule],
  templateUrl: './radiotestmasterparameterlist.component.html',
  styleUrl: './radiotestmasterparameterlist.component.css'
})
export class RadiotestmasterparameterlistComponent {
...
this.filterForm.get('searchText')?.valueChanges
  ...
  editMedicaltest(medicalId: string) {
    ...
    this.router.navigate(['/radiologylayout/radiotestparametermaster'], { queryParams: { _id: medicalId } });
  }
