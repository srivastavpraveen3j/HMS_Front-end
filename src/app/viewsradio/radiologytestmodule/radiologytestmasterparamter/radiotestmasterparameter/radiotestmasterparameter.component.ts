...
@Component({
  selector: 'app-radiotestmasterparameter',
    imports: [CommonModule, RouterModule, ReactiveFormsModule],
  templateUrl: './radiotestmasterparameter.component.html',
  styleUrl: './radiotestmasterparameter.component.css'
})
export class RadiotestmasterparameterComponent {
  ...
  if (medicaltestId) {
    ...
    this.masterService.updateMedicaltest(medicaltestId, formData).subscribe({
      next: () => {
        ...
        this.router.navigateByUrl('/radiologylayout/radiotestparametermasterlist');
      },
      error: (error) => {
