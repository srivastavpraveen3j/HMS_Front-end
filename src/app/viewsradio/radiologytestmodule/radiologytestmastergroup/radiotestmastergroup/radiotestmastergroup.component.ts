...
@Component({
  selector: 'app-radiotestmastergroup',
  imports: [RouterModule, CommonModule, ReactiveFormsModule],
  templateUrl: './radiotestmastergroup.component.html',
  styleUrl: './radiotestmastergroup.component.css'
})
export class RadiotestmastergroupComponent {
  ...
  if (medicaltestId) {
    ...
    this.masterService.updateMedicaltestGroup(medicaltestId, formData).subscribe({
      next: () => {
        ...
        this.router.navigateByUrl('/radiologylayout/radiotestgroupmasterlist');
      },
      error: (error) => {
