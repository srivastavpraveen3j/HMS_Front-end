...
@Component({
  selector: 'app-radiotestmastergrouplist',
  imports: [RouterModule, CommonModule, ReactiveFormsModule],
  templateUrl: './radiotestmastergrouplist.component.html',
  styleUrl: './radiotestmastergrouplist.component.css'
})
export class RadiotestmastergrouplistComponent {
...
// load permissions
  ...
  .subscribe((searchText: string) => {
    ...
    editMedicaltest(medicalId: string) {
      ...
      this.router.navigate(['/master/medicaltestgroup'], { queryParams: { _id: medicalId } });
    }
