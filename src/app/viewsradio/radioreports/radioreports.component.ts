...
import { FormsModule } from '@angular/forms';import { TestService } from '../../viewspatho/testservice/test.service';
@Component({
  selector: 'app-radioreports',
  imports: [CommonModule, RouterModule, TestComponent, LoaderComponent, FormsModule],
  templateUrl: './radioreports.component.html',
  styleUrl: './radioreports.component.css'
})
export class RadioreportsComponent {
title = '';
