...
@Component({
  selector: 'app-pathoreportdepartmentwiseopdreport',
  imports: [
    CommonModule,
    FormsModule,
  ...
  templateUrl: './pathoreportdepartmentwiseopdreport.component.html',
  styleUrl: './pathoreportdepartmentwiseopdreport.component.css',
})
export class PathoreportdepartmentwiseopdreportComponent {
  title: String = '';
  subTitle: String = '';
