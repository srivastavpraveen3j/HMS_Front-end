...
@Component({
  selector: 'app-walkinpathoinward',
  imports: [
    CommonModule,
  ...
  templateUrl: './walkinpathoinward.component.html',
  styleUrl: './walkinpathoinward.component.css',
})
export class WalkinpathoinwardComponent {
  doctors: any[] = [];
