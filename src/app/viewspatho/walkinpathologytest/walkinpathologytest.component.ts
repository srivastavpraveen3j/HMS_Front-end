...
@Component({
  selector: 'app-walkinpathologytest',
    imports: [
    RouterModule,
    ReactiveFormsModule,
    CommonModule,
  ],
  templateUrl: './walkinpathologytest.component.html',
  styleUrl: './walkinpathologytest.component.css'
})
export class WalkinpathologytestComponent {
    ...
    onSubmit(): void {
      ...
      this.testservice.postTestreq(payload).subscribe({
        next: (res) => {
          ...
          this.router.navigateByUrl('/pathologylayout/walkinpathoinward');
        },
        error: (err) => {
