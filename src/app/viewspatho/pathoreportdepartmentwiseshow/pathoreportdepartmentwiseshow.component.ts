...
@Component({
  selector: 'app-pathoreportdepartmentwiseshow',
  imports: [
    CommonModule,
    FormsModule,
  ...
  templateUrl: './pathoreportdepartmentwiseshow.component.html',
  styleUrl: './pathoreportdepartmentwiseshow.component.css',
})
export class PathoreportdepartmentwiseshowComponent {
  title: String = '';
  subTitle: String = '';
  ...
  ngOnInit(): void {
    ...
    this.route.queryParams.subscribe((params) => {
      this.title = params['title'] || 'OPD PATHOLOGY PATIENTS';
    });
