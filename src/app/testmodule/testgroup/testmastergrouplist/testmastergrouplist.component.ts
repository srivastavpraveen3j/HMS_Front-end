...
@Component({
  selector: 'app-testmastergrouplist',
    imports: [RouterModule, CommonModule, ReactiveFormsModule],
  templateUrl: './testmastergrouplist.component.html',
  styleUrl: './testmastergrouplist.component.css'
})
export class TestmastergrouplistComponent {
 ...
 // load permissions
  ...
  .subscribe((searchText: string) => {
    ...
    editMedicaltest(medicalId: string) {
      ...
      this.router.navigate(['/pathologylayout/testgroup'], { queryParams: { _id: medicalId } });
    }
