...
@Component({
  selector: 'app-testmasterparameter',
  imports: [CommonModule, RouterModule, ReactiveFormsModule],
  templateUrl: './testmasterparameter.component.html',
  styleUrl: './testmasterparameter.component.css'
})
export class TestmasterparameterComponent {
   ...
   if (medicaltestId) {
     ...
     this.masterService.updateMedicaltest(medicaltestId, formData).subscribe({
       next: () => {
         ...
         this.router.navigateByUrl('/pathologylayout/testparameterlist');
       },
       error: (error) => {
