...
@Component({
  selector: 'app-testmasterparameterlist',
  imports: [RouterModule, CommonModule, ReactiveFormsModule],
  templateUrl: './testmasterparameterlist.component.html',
  styleUrl: './testmasterparameterlist.component.css'
})
export class TestmasterparameterlistComponent {
...
this.filterForm.get('searchText')?.valueChanges
  ...
  editMedicaltest(medicalId: string) {
    ...
    this.router.navigate(['/pathologylayout/testparameter'], { queryParams: { _id: medicalId } });
  }
