...
@Component({
  selector: 'app-pahrmareportsexpired',
  imports: [ CommonModule,
    FormsModule,
    CanvasJSAngularChartsModule,
    LoaderComponent,],
  templateUrl: './pahrmareportsexpired.component.html',
  styleUrl: './pahrmareportsexpired.component.css'
})
export class PahrmareportsexpiredComponent {
...
constructor(
  ...
  ngOnInit(): void {
    ...
    this.route.queryParams.subscribe((params) => {
      this.title = params['title'] || 'EXPIRED PHARMA MEDICINES';
    });
