...
@Component({
  selector: 'app-opdpharmadashboard',
  imports: [
    CommonModule,
    ReactiveFormsModule,
  ...
  templateUrl: './opdpharmadashboard.component.html',
  styleUrl: './opdpharmadashboard.component.css',
})
export class OpdpharmadashboardComponent {
  doctors: any[] = [];
  ...
  (perm: any) => perm.moduleName === 'ipdpharmaceuticalRequestList'
    ...
    this.ipduserPermissions = ipdpharmamodule?.permissions || {};
