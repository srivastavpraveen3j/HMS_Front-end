...
@Component({
  selector: 'app-centeral-storeallotedreport',
  imports: [CommonModule,
    FormsModule,
    CanvasJSAngularChartsModule,
    LoaderComponent,],
  templateUrl: './centeral-storeallotedreport.component.html',
  styleUrl: './centeral-storeallotedreport.component.css'
})
export class CenteralStoreallotedreportComponent {
...
constructor(
  ...
  ngOnInit(): void {
    ...
    this.route.queryParams.subscribe((params) => {
      this.title = params['title'] || 'STOCK ALLOTED FROM CENTERAL STORE';
    });
