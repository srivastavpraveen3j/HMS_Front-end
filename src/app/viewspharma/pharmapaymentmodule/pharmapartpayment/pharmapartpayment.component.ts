...
@Component({
  selector: 'app-pharmapartpayment',
    imports: [CommonModule, BillingDiscountBoxComponent, ReactiveFormsModule],
  templateUrl: './pharmapartpayment.component.html',
  styleUrl: './pharmapartpayment.component.css'
})
export class PharmapartpaymentComponent {
