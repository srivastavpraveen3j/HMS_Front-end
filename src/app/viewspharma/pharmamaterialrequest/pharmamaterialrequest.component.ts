...
import { MaterialrequestService } from '../purchase order management/purchaserequest/service/materialrequest.service';
import { RoleService } from '../../views/mastermodule/usermaster/service/role.service';

@Component({
  selector: 'app-pharmamaterialrequest',
  imports: [RouterModule, CommonModule, ReactiveFormsModule],
  templateUrl: './pharmamaterialrequest.component.html',
  styleUrl: './pharmamaterialrequest.component.css',
})
export class PharmamaterialrequestComponent {
