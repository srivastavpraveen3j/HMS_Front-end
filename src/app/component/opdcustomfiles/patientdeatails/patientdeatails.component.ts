...
@Component({
  selector: 'app-patientdeatails',
  imports: [CommonModule, RouterModule],
  templateUrl: './patientdeatails.component.html',
  styleUrl: './patientdeatails.component.css',
})
export class PatientdeatailsComponent {
  @Input() patientData: any;
  @Input() patientVital: any;
  patient: any[] = [];
