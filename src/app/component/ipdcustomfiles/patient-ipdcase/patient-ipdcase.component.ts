...
@Component({
  selector: 'app-patient-ipdcase',
  imports: [CommonModule, RouterModule],
  templateUrl: './patient-ipdcase.component.html',
  styleUrl: './patient-ipdcase.component.css',
})
export class PatientIpdcaseComponent {
  ...
  //     this.patient = this.patientData[0]; // safely extract the first (and only) patient
  //     console.log('Diagnosis object:', this.patient.diagnosis);
