...
@Component({
  selector: 'app-ipd-medico-legal-case',
  imports: [
    CommonModule,
    FormsModule,

  ],
  templateUrl: './ipd-medico-legal-case.component.html',
  styleUrl: './ipd-medico-legal-case.component.css',
})
export class IpdMedicoLegalCaseComponent {
  ipdData: any[] = [];
  medicoLegalData: any[] = [];
  filteredDoctors: any[] = [];
