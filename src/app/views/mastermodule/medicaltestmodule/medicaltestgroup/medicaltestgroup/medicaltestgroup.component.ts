...
@Component({
  selector: 'app-medicaltestgroup',
    imports: [RouterModule, CommonModule, ReactiveFormsModule],
  templateUrl: './medicaltestgroup.component.html',
  styleUrl: './medicaltestgroup.component.css'
})
export class MedicaltestgroupComponent {
  ...
  if (medicaltestId) {
    ...
    this.masterService.updateMedicaltestGroup(medicaltestId, formData).subscribe({
      next: () => {
        ...
        this.router.navigateByUrl('/master/medicaltestgrouplist');
      },
      error: (error) => {
