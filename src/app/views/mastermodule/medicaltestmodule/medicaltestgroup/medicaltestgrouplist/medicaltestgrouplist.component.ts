...
@Component({
  selector: 'app-medicaltestgrouplist',
    imports: [RouterModule, CommonModule, ReactiveFormsModule],
  templateUrl: './medicaltestgrouplist.component.html',
  styleUrl: './medicaltestgrouplist.component.css'
})
export class MedicaltestgrouplistComponent {
