...
@Component({
  selector: 'app-opdpathologyreqlist',
  imports: [
    CommonModule,
    RouterModule,
    TestComponent,
  ...
  templateUrl: './opdpathologyreqlist.component.html',
  styleUrl: './opdpathologyreqlist.component.css',
})
export class OpdpathologyreqlistComponent {
