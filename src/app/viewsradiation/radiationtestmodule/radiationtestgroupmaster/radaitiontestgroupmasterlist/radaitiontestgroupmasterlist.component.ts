...
@Component({
  selector: 'app-radaitiontestgroupmasterlist',
      imports: [RouterModule, CommonModule, ReactiveFormsModule],
  templateUrl: './radaitiontestgroupmasterlist.component.html',
  styleUrl: './radaitiontestgroupmasterlist.component.css'
})
export class RadaitiontestgroupmasterlistComponent {
...
// load permissions
  ...
  .subscribe((searchText: string) => {
    ...
    loadMedicaltest(): void {
      ...
      this.masterService.getmedicaltestGroup(this.currentPage, limit, search).subscribe(res => {
    ...
    editMedicaltest(medicalId: string) {
      ...
      this.router.navigate(['/radiationlayout/radiationtestgroup'], { queryParams: { _id: medicalId } });
    }
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        this.masterService.deleteMedicaltestGroup(medicalId).subscribe({
          next: () => {
            Swal.fire({
              icon: 'success',
              title: 'Deleted!',
